...
void test_case_2()
{
    ...
    auto chain14_15_cb_group = std::make_shared<rclcpp::CallbackGroup>(rclcpp::CallbackGroupType::MutuallyExclusive);
    auto chain14_15 = std::make_shared<Chain>(7);
    auto c7_cb1 = std::make_shared<Callback>(CallbackType::TIMER, timeval{0, 200000}, 5, 1, 1, "adversarial_pointcloud_map", "", "c7_cb1", 512000, chain14_15_cb_group);
    auto c7_cb2 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 2, 3, "adversarial_pointcloud_map_loader", "c7_cb1", "c7_cb2", 512000, chain14_15_cb_group);
    auto c7_cb3 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 3, 5, 0, "adversarial_ndt_localizer", "c7_cb2", "c7_cb3", 512000, chain14_15_cb_group, true);
    auto c7_cb4 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 4, 7, 0, "adversarial_lanelet_2_global_planner_input", "c7_cb3", "", 512000, chain14_15_cb_group);
    auto c7_cb5 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 4, 18, 1, "adversarial_behavior_planner_input_5", "c7_cb3", "", 512000, chain14_15_cb_group);
    c7_cb1->setChain(chain14_15);
    c7_cb2->setChain(chain14_15);
    c7_cb3->setChain(chain14_15);
    c7_cb4->setChain(chain14_15);
...
void baseline_2()
{
    ...
    auto chain14_15_cb_group = std::make_shared<rclcpp::CallbackGroup>(rclcpp::CallbackGroupType::MutuallyExclusive);
    auto chain14_15 = std::make_shared<Chain>(7);
    auto c7_cb1 = std::make_shared<Callback>(CallbackType::TIMER, timeval{0, 150000}, 5, 1, 1, "adversarial_pointcloud_map", "", "c7_cb1", 512000, chain14_15_cb_group);
    auto c7_cb2 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 2, 3, "adversarial_pointcloud_map_loader", "c7_cb1", "c7_cb2", 512000, chain14_15_cb_group);
    auto c7_cb3 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 3, 5, 0, "adversarial_ndt_localizer", "c7_cb2", "c7_cb3", 512000, chain14_15_cb_group, true);
    auto c7_cb4 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 4, 7, 0, "adversarial_lanelet_2_global_planner_input", "c7_cb3", "", 512000, chain14_15_cb_group);
    auto c7_cb5 = std::make_shared<Callback>(CallbackType::SUBSCRIPTION, timeval{0, 0}, 5, 4, 18, 1, "adversarial_behavior_planner_input_5", "c7_cb3", "", 512000, chain14_15_cb_group);
...
void test_case_4()
{
    ...
    std::this_thread::sleep_for(std::chrono::seconds(120));
    set_cpu_frequency("1728000");
    std::this_thread::sleep_for(std::chrono::seconds(120));
    std::cerr << "experiment finished, please kill";
    //rclcpp::shutdown();
    // if (ret != 0)
    // {
    //     std::cerr << "Failed to set mpc controller thread to RT Prio 99: " << strerror(errno) << std::endl;
